...
#define FRAME_BUFFER_0_ADDR 0xC9000000  // Starting location in DDR where we will store the images that we display.
...
int main()
{
    ...
    // IP.
 	...
 	for (display_height = 0; display_height < 480; display_height++) {
 		for (display_width = 0; display_width < 640; display_width++) {
 			framePointer0[display_height * 640 + display_width] = 0x00000000; // frame 0 is red here.
 		}
 	}
